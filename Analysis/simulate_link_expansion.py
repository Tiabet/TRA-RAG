...
def main():
    ...
    # Map Question -> Gold Supporting Facts
    q_to_gold = {}
    ...
    # We need to index ALL docs in the metadata file
    ...
    print("Simulating Link Expansion...")
    ...
    for item in results_data['results']:
        ...
        for title in retrieved_titles:
            # Find neighbors
            # Neighbors are docs that share ANY value with this doc
            # BUT we must exclude the doc itself
    ...
    print("\n" + "="*50)
    print("RETRIEVAL SIMULATION REPORT")
    print("="*50)
    ...
    print("\n[Simulation: Full Link Expansion (S-S & S-D)]")
