"""
Comprehensive Test: 200 queries with question type analysis
============================================================
- Tests all 200 queries
- Tracks unmatched queries
- Analyzes by question type (bridge vs comparison)
"""
import asyncio
import json
...
async def main():
    ...
    try:
        ...
        print("="*80)
        print(f"COMPREHENSIVE TEST: {len(test_data)} queries")
        print("="*80)
        ...
        output_file = 'test_results_200_detailed.json'
        ...
        # Summary comparison
        print("\n" + "="*80)
        print("BRIDGE vs COMPARISON COMPARISON")
        print("="*80)
