#!/usr/bin/env python3
""" 
Test New Multi-hop Pipeline v6 on 200 Questions
==============================================

Delta vs v5:
- Initial retrieval uses SQ (effective_query) as-is.
- Expansion reranking uses main_query.

Usage:
    python test_pipeline_v6_200.py                     # Default: MuSiQue
    python test_pipeline_v6_200.py --dataset hotpotqa  # HotpotQA
    python test_pipeline_v6_200.py --dataset musique   # MuSiQue
"""
...
DATASET_CONFIGS = {
    ...
    "musique": {
        ...
        "result_path": "Results/test_musique_v6_200_results_v1.json",
    },
}
...
async def process_single_question(pipeline, item, idx, total):
    ...
    try:
        ...
        # Count unique passages used across SQs
        num_passages = 0
...
async def main():
    parser = argparse.ArgumentParser(description="Test Pipeline V6")
    parser.add_argument(
        "--dataset",
        type=str,
        default="musique",
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.6,
        help="Weight for dense retrieval (0.0-1.0)",
    )
    ...
    linker = MetadataLinkerV6(config["metadata_json"])
    ...
    output = {
        "config": {
            ...
            "mode": "initial_sq + expanded_rerank_main_query",
