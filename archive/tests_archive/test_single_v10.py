#!/usr/bin/env python3
"""Run a single question through Pipeline v10 (MuSiQue by default)."""
...
async def main():
    ...
    linker = MetadataLinkerValuesOnly(metadata_path)
    ...
    pipeline = PipelineV10(
        ...
        initial_top_paths=10,
        final_top_passages=5,
        verbose=True,
    )
    ...
    print("Seed values count:", ri.get("seed_values_count"))
