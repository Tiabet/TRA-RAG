#!/usr/bin/env python3
"""Test Pipeline v9 (no QD) on 200 questions."""
...
DATASET_CONFIGS = {
    "hotpotqa": {
        ...
        "result_path": "Results/test_hotpot_v9_200_results_v1.json",
    },
    "musique": {
        ...
        "result_path": "Results/test_musique_v9_200_results_v1.json",
    },
}
...
async def main():
    parser = argparse.ArgumentParser(description="Test pipeline v9")
    ...
    parser.add_argument("--initial_top_paths", type=int, default=3)
    parser.add_argument("--final_top_passages", type=int, default=10)
    ...
    linker = MetadataLinkerFull(cfg["metadata_json"])
    pipeline = PipelineV9(
        client=client,
        retriever=retriever,
        linker=linker,
    ...
    output = {
        "config": {
            ...
            "initial_top_paths": args.initial_top_paths,
            "final_top_passages": args.final_top_passages,
            "linking": "full (keys+values, no filters)",
        },
        "summary": {
